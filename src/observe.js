...
const strategic=name=>/(_ore|_log|_wood|_stem|_hyphae|ancient_debris|chest|barrel|crafting_table|furnace|smoker|anvil|enchanting_table|brewing_stand|spawner|portal|end_gateway|lava|water|_sign)$/.test(name||'')
