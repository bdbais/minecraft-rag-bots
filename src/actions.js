...
export function autonomousProgressionDecision(bot, observation = {}, checkpoints = []) {
  ...
  if(table&&blazePowder>=4&&pearls>=4&&eyes<4)return{thought:'Campagna End: polvere di blaze e perle sufficienti per creare gli occhi.',goal:'craftare Eyes of Ender per cercare la stronghold',action:'craft',args:{name:'ender_eye',count:Math.min(4,blazePowder,pearls)},expected:'Eyes of Ender nell’inventario'}
